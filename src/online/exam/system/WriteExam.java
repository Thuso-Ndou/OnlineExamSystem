...
public class WriteExam extends javax.swing.JFrame {
   // creating variables
    ...
    public WriteExam(String registrationNumber1, String moduleTable, String moduleName) {
        initComponents();
    ...
    {  
        if(minutes == 0 && seconds == 0)
        {
            ...
            setVisible(false);
            new ExamCompleted(marks,numberOfQuestions).setVisible(true);
        } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WriteExam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
