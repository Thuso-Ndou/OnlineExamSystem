 ...
 * @author Thuso Maps
 */
public class ExamFeedBackStudent extends javax.swing.JFrame {
     ...
     */
    public ExamFeedBackStudent() {
        initComponents();
    }
    
    public ExamFeedBackStudent(String registrationNo) {
        initComponents();
  ...
  private void handlePreviousButton()
  {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExamFeedBackStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExamFeedBackStudent().setVisible(true);
            }
        });
    }
