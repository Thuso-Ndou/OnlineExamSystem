 ...
 * @author Thuso Maps
 */
public class AccountLecturer extends javax.swing.JFrame {
    ...
    public AccountLecturer(String registrationNumber1, String firstName1, String lastName1, String gender1, String systemRole1, String email1, String systemPassword1) 
    {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(systemPassword.equals(txtOldPassword.getText()) && !(txtNewPassword.getText().isEmpty()))
        {
            ...
            {
                // query statement
                PreparedStatement ps = con.prepareStatement("UPDATE lecturers SET RegistrationNumber=?,FirstName=?, LastName=?,Gender=?,SystemRole=?,Email=?,SystemPassword=?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AccountLecturer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AccountLecturer().setVisible(true);
            }
        });
    }
