 ...
 * @author Thuso Maps
 */
public class WriteExamInstructions extends javax.swing.JFrame {
    public String registrationNumber;

    /**
     * Creates new form WriteExam
     */
    public WriteExamInstructions() {
        initComponents();
    }
    
    public WriteExamInstructions(String registrationNumber1) {
        initComponents();
    ...
    private void btnStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStartActionPerformed
        // write exam
        setVisible(false);
        new WriteExamSelectModule(registrationNumber).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WriteExamInstructions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WriteExamInstructions().setVisible(true);
            }
        });
    }
