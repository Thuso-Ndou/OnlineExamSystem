 ...
 * @author Thuso Maps
 */
public class WriteExamSelectModuleStudent extends javax.swing.JFrame {
     ...
     */
    public WriteExamSelectModuleStudent() {
        initComponents();
    }
    
    public WriteExamSelectModuleStudent(String registration) {
        initComponents();
    ...
    private void btnDoneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoneActionPerformed
        ...
        try
        {
            ...
            setVisible(false);
            new WriteExamStudent(registrationNumber,ModuleTable,selectedModule).setVisible(true);
        }
        catch (SQLException ex) 
        {
            // display message
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WriteExamSelectModuleStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WriteExamSelectModuleStudent().setVisible(true);
            }
        });
    }
