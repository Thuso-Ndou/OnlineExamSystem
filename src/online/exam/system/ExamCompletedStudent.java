 ...
 * @author Thuso Maps
 */
public class ExamCompletedStudent extends javax.swing.JFrame {
    ...
    public ExamCompletedStudent() {
        initComponents();
    }
    
     public ExamCompletedStudent(int total, int numberOfQuestions) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExamCompletedStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExamCompletedStudent().setVisible(true);
            }
        });
    }
