 ...
 * @author Thuso Maps
 */
public class ExamGradeStudent extends javax.swing.JFrame {
    ...
    public ExamGradeStudent() {
        initComponents();
    }
    
    public ExamGradeStudent(String registration, String first, String last, String Email) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBoxModules.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBoxModulesActionPerformed(evt);
            }
        });
    ...
    private void jComboBoxModulesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxModulesActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jComboBoxModulesActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExamGradeStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExamGradeStudent().setVisible(true);
            }
        });
    }
